    ...
    return (
        ...
        >
            ...
            <div className="fixed  bottom-0 left-0 right-0 py-5 mx-3 bg-white  justify-between grid grid-cols-2 gap-4  ">
                <Button varaiant={'ghost'} text={'Save & add another'} onClick={handleSubmit((data) => AddNewExpense(data, false))} />
                <Button varaiant={'primary'} text={'Save'} disabled={!isValid} onClick={handleSubmit((data) => AddNewExpense(data))} />
            </div>
